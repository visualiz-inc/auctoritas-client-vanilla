...
export const TEST_AUTH0_CLIENT_QUERY_STRING = `&auctoritasClient=${encodeURIComponent(
  btoa(
    JSON.stringify({
...
export const GET_TOKEN_SILENTLY_LOCK_KEY = 'auctoritas.lock.getTokenSilently';
