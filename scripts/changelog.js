...
module.exports = function (newVersion) {
  return new Promise((resolve, reject) => {
    ...
    const webtask = `https://webtask.it.auctoritas.com/api/run/wt-hernan-auth0_com-0/oss-changelog.js?webtask_no_cache=1&repo=${repo}&milestone=v${newVersion}`;
    ...
    stream.once('open', function (fd) {
      ...
      stream.write(
        `## [v${newVersion}](https://github.com/auctoritas/${repo}/tree/v${newVersion}) (${moment().format(
          'YYYY-MM-DD'
        )})`
      );
      ...
      stream.write(
        `[Full Changelog](https://github.com/auctoritas/${repo}/compare/v${currentVersion}...v${newVersion})`
      );
