...
const footer = `('AuctoritasClient' in this) && this.console && this.console.warn && this.console.warn('AuctoritasClient already declared on the global namespace');
this && this.${EXPORT_NAME} && (this.AuctoritasClient = this.AuctoritasClient || this.${EXPORT_NAME}.AuctoritasClient);`;
...
let bundles = [
  {
    ...
    output: {
      name: EXPORT_NAME,
      file: 'dist/auctoritas-spa-js.development.js',
      footer,
      format: 'umd',
      sourcemap: true
    },
  ...
  bundles = bundles.concat(
    {
      ...
      output: [
        {
          name: EXPORT_NAME,
          file: 'dist/auctoritas-spa-js.production.js',
          footer,
          format: 'umd'
        }
      ],
